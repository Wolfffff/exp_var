...
#     metadata_df <- convert_metadata_to_df_rc3(sample_attributes = colData(rse)$sra.sample_attributes)
#   }
...
#     rse@assays@data[["raw_counts"]] = assays(rse)[["raw_counts"]][, metadata_df$rownames] 
#   }
