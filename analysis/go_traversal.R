...
local_go_upper = enrichGO(gene  = upper_quantiles[[metric]],
                          ...
                          qvalueCutoff  = 0.001,
                          readable      = TRUE)
write_csv(local_go_upper@result |> filter(p.adjust > 0.01), here::here("data/annotation/go_upper_quantile.csv"))
...
local_go_lower = enrichGO(gene  = lower_quantiles[[metric]],
                          ...
                          qvalueCutoff  = 0.001,
                          readable      = TRUE)
write_csv(local_go_lower@result |> filter(p.adjust > 0.01), here::here("data/annotation/go_lower_quantile.csv"))
